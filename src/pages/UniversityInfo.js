    ...
    <Toolbar /> 
      <MuiThemeProvider theme={theme}>
        <Grid container spacing={2}>
          ...
          >
              <img src = "https://lh3.googleusercontent.com/proxy/4z-njd6w9cq0JDVnuTkUNc5CfiLFDlwZK1Wsz6G55S8zGholPTpHtiw9G7OlcrEaWkAE5m9pxSbflTu9CW2mMXm9yaf66IEwpWa442qAdLq-8qR0"  style={{width:'100%', height:'100%',borderRadius:'50%'}} ></img>
        </Paper>
